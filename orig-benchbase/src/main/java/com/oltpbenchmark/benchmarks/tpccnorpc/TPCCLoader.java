...
import com.oltpbenchmark.benchmarks.tpccnorpc.pojo.*;
 ...
 */
public class TPCCLoader extends Loader<TPCCnorpcBenchmark> {

    private static final int FIRST_UNPROCESSED_O_ID = 2101;

    private final long numWarehouses;

    public TPCCLoader(TPCCnorpcBenchmark benchmark) {
        super(benchmark);
