...
import static com.oltpbenchmark.benchmarks.tpccnorpc.TPCCConfig.*;
...
public class TPCCUtil {
    ...
    // rxy: a created customer object for the payment transaction
    public static Customer newPayCustomerFromResults(ResultSet rs)
            throws SQLException {
        Customer c = new Customer();
        // add c_w_id, c_d_id, c_id and c_last
