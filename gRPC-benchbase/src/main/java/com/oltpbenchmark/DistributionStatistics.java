...
public class DistributionStatistics {
    ...
    public Map<String, Integer> toSuccessMap() {
        Map<String, Integer> distMap = new LinkedHashMap<>();
        distMap.put("Success Minimum Latency (microseconds)", (int) getMinimum());
        distMap.put("Success 25th Percentile Latency (microseconds)", (int) get25thPercentile());
        distMap.put("Success Median Latency (microseconds)", (int) getMedian());
        distMap.put("Success Average Latency (microseconds)", (int) getAverage());
        distMap.put("Success 75th Percentile Latency (microseconds)", (int) get75thPercentile());
        distMap.put("Success 90th Percentile Latency (microseconds)", (int) get90thPercentile());
        distMap.put("Success 95th Percentile Latency (microseconds)", (int) get95thPercentile());
        distMap.put("Success 99th Percentile Latency (microseconds)", (int) get99thPercentile());
        distMap.put("Success Maximum Latency (microseconds)", (int) getMaximum());
        return distMap;
    }
}