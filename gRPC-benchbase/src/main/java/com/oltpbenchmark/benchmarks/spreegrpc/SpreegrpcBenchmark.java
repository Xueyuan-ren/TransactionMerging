...
import com.oltpbenchmark.benchmarks.spreegrpc.procedures.NewOrder;
...
public class SpreegrpcBenchmark extends BenchmarkModule {
    private static final Logger LOG = LoggerFactory.getLogger(SpreegrpcBenchmark.class);

    public SpreegrpcBenchmark(WorkloadConfiguration workConf) {
        super(workConf);
    }
    ...
    @Override
    protected Loader<SpreegrpcBenchmark> makeLoaderImpl() {
