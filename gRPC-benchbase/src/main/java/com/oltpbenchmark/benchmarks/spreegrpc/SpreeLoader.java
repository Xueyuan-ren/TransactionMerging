...
import com.oltpbenchmark.benchmarks.spreegrpc.pojo.*;
 ...
 * Spree Loader
 */
public class SpreeLoader extends Loader<SpreegrpcBenchmark> {

    private final long numWarehouses;

    private final Random rand = new Random();

    public SpreeLoader(SpreegrpcBenchmark benchmark) {
        super(benchmark);
