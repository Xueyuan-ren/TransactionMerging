...
import com.oltpbenchmark.benchmarks.tpccgrpc.pojo.*;
 ...
 */
public class TPCCLoader extends Loader<TPCCgrpcBenchmark> {

    private static final int FIRST_UNPROCESSED_O_ID = 2101;

    private final long numWarehouses;

    public TPCCLoader(TPCCgrpcBenchmark benchmark) {
        super(benchmark);
